...
Change log
r3171 by rdworth on Aug 28, 2009   Diff

selectable refactor: added ui-selectble-
item instead of ui-state-default, added
ui-selected in addition to ui-state-
active, fixed theme to have transparent
1px border for ui-selectable-item to match
border width that ui-
state-(active/hover/focus) add

Go to: 	

Older revisions
r3170 by rdworth on Aug 28, 2009   Diff

selectable refactor: fixed destroy to
remove ui-widget class

r3150 by paul.bakaus on Aug 27, 2009   Diff

selectable dev: selectable can now be
properly disabled

r3149 by paul.bakaus on Aug 27, 2009   Diff

selectable dev: removed multiple
option

All revisions of this file

File info
Size: 19651 bytes, 660 lines
View raw file
